(()=>{
  ...
  function installStyles(){
    ...
    const style=document.createElement('style');style.id='promptAiHomeFinalStyles';style.textContent=`
      ...
      .prompt-attach-button{display:grid;place-items:center;width:38px;height:38px;padding:0;border:0;border-radius:11px;background:transparent;color:#c8d6e2;font:400 24px/1 Arial,Helvetica,sans-serif;cursor:pointer}
      .prompt-attach-button:hover{background:rgba(255,255,255,.07);color:#e7f1f9}
      ...
      .prompt-setup-line{position:relative;flex:0 0 auto;display:grid;place-items:center;width:38px;height:38px;padding:0;border:1px solid #33465a;border-radius:11px;background:transparent;color:#c8d6e2;cursor:pointer}
