(()=>{
  ...
  function installStyles(){
    ...
    const style=document.createElement('style');style.id='promptAiHomeFinalStyles';style.textContent=`
      ...
      html.prompt-home-surface #promptFooter{width:min(clamp(1040px,78vw,1520px),calc(100% - 30px));margin:0 auto;background:transparent!important;border-top:1px solid var(--home-line)!important}html.prompt-home-surface #promptFooter .prompt-footer-content{min-height:56px!important;padding:12px 2px!important}
