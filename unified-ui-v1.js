(()=>{
  ...
  function installStyles(){
    ...
    s.textContent=`
      ...
      body.prompt-unified-ui dialog:not(#previewLightbox):not(#welcomeIntroDialog):not(#adminDialog):not(#libraryDialog):not(#settingsDialog):not(#profileDialog):not(#clarificationDialog):not(#subscriptionOverviewDialog):not(#accountDialog):not(#plansDialog):not(#legalDialog):not(#appActionDialog) .dialog-frame{width:min(900px,calc(100vw - 28px))!important;max-width:900px!important;max-height:calc(100dvh - 28px)!important;margin:auto!important;border:1px solid var(--ui-line)!important;border-radius:22px!important;background:var(--ui-card)!important;box-shadow:var(--ui-shadow)!important;overflow-y:auto!important;overflow-x:hidden!important}
