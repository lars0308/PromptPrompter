...
const TASKS=['analysis','questions','prompt','website','image','learning'];
...
async function listProfiles(task,{enabledOnly=true,providers=[]}={}){
  ...
  try{
    let path='/rest/v1/sitebrief_system_ai_profiles?select=id,label,provider,model,tasks,priority,enabled,updated_at';
