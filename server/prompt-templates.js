...
const DEFAULTS=[
 ...
 },
 {
  ...
  "body": "Prüfe dieses Website- oder Web-App-Projekt, BEVOR gestalterische Richtungen entstehen. Entscheide, ob wesentliche Angaben fehlen, sich widersprechen, nicht umsetzbar oder riskant sind oder zu einer schlechten Umsetzung führen würden - inhaltlich wie gestalterisch. Stelle höchstens {{max}} knappe Fragen. Gestaltung und persönlicher Geschmack gehören ausdrücklich dazu, wenn der Auftrag eine Richtung andeutet, sie aber offen lässt: dann frage danach und schlage konkret vor, statt still etwas anzunehmen. Höchstens zwei deiner Fragen betreffen Gestaltung, und keine davon fragt nach Details, die die Vorschau ohnehin zeigt."
 },
 {
  "key": "review-rules",
