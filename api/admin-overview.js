...
module.exports=async function(req,res){
  ...
  try{
    ...
    const [auth,subscriptions,profiles,projects,usage,states,announcements,offers,support,aiConnections,previewAiRoutes,quotaLimits,maintenanceRows]=await Promise.all([
