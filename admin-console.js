(()=>{
  ...
  load('./admin-console-core.js?v=20260810-3',()=>load('./ui-regression-fixes.js?v=20260810-3',()=>load('./mode-flow-ui.js?v=20260810-1',()=>load('./preview-ai-admin.js?v=20260810-1'))));
})();
