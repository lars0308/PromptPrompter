(()=>{
  ...
  load('./admin-console-core.js?v=20260810-6',()=>load('./ui-regression-fixes.js?v=20260810-6',()=>load('./mode-flow-ui.js?v=20260810-4',()=>load('./preview-ai-admin.js?v=20260810-4',()=>load('./product-polish.js?v=20260810-1')))));
})();
