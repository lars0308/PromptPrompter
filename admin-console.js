(()=>{
  ...
  load('./admin-console-core.js?v=20260810-5',()=>load('./ui-regression-fixes.js?v=20260810-5',()=>load('./mode-flow-ui.js?v=20260810-3',()=>load('./preview-ai-admin.js?v=20260810-3'))));
})();
