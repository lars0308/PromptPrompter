(()=>{
  ...
  async function critical(){await load('./cloud-fast-bundle.js?v=20260813-2');await load('./mode-handoff-fix.js?v=20260813-2');await load('./transition-polish.js?v=20260813-8');await loadCore();await load('./ui-regression-fixes.js?v=20260813-2');await load('./project-start-ui.js?v=20260813-2');await load('./stability-ui.js?v=20260813-4');await load('./mode-flow-ui.js?v=20260813-3');await load('./system-ai-routing.js?v=20260813-2');await load('./system-ai-studio.js?v=20260813-2');await load('./product-polish.js?v=20260813-2');await load('./workflow-cleanup.js?v=20260813-2');await load('./preview-mode-fix.js?v=20260813-2');await load('./free-prompt-ui.js?v=20260813-2');await load('./free-prompt-presets.js?v=20260813-2');await load('./home-entry-ui.js?v=20260813-6');await load('./streamlined-project-flow.js?v=20260813-2');await load('./guided-clean-ui.js?v=20260813-2');await load('./unified-ui-v1.js?v=20260813-6');await load('./trial-fix-ui.js?v=20260813-2');await load('./subscription-ui.js?v=20260813-2');await load('./usage-quota-ui.js?v=20260813-2');await load('./ux-stability-fix.js?v=20260813-4');await load('./ui-polish-final.js?v=20260813-2');await load('./ui-final-touch.js?v=20260813-2');await load('./promptai-experience-v1.js?v=20260813-2');await load('./promptai-loading-v2.js?v=20260813-2');await load('./promptai-experience-v2.js?v=20260813-2');await load('./promptai-home-final.js?v=20260813-3');await load('./promptai-full-app-design.js?v=20260813-2');document.querySelector('#freePromptCategory option[value="website"]')?.remove();const intro=document.querySelector('#freePromptDialog .free-prompt-intro');if(intro)intro.textContent='Wähle jetzt Typ und Ziel-Tool. Weitere Angaben sind optional.';document.documentElement.classList.add('prompt-home-ready')}
