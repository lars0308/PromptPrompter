(()=>{
  ...
  const CORE_SCRIPT='./admin-console-core.js?v=20260817-21';
  ...
  const CRITICAL_SCRIPTS=['./error-beacon.js?v=20260817-21','./plan-defaults.js?v=20260817-21','./project-state.js?v=20260817-21','./plan-preview-ui.js?v=20260817-21','./cloud-fast-bundle.js?v=20260817-21','./mode-handoff-fix.js?v=20260817-21','./transition-polish.js?v=20260817-21','./announcement-popup.js?v=20260817-21','core','./ui-regression-fixes.js?v=20260817-21','./project-start-ui.js?v=20260817-21','./stability-ui.js?v=20260817-21','./mode-flow-ui.js?v=20260817-21','./system-ai-routing.js?v=20260817-21','./system-ai-studio.js?v=20260817-21','./product-polish.js?v=20260817-21','./workflow-cleanup.js?v=20260817-21','./preview-mode-fix.js?v=20260817-21','./free-prompt-ui.js?v=20260817-21','./free-prompt-presets.js?v=20260817-21','./home-entry-ui.js?v=20260817-21','./website-build-ui.js?v=20260817-21','./project-extras-ui.js?v=20260817-21','./welcome-intro-ui.js?v=20260817-21','./project-context-ui.js?v=20260817-21','./save-toast-ui.js?v=20260817-21','./flow-guards-ui.js?v=20260817-21','./settings-connections-ui.js?v=20260817-21','./user-preferences-ui.js?v=20260817-21','./streamlined-project-flow.js?v=20260817-21','./guided-clean-ui.js?v=20260817-21','./unified-ui-v1.js?v=20260817-21','./trial-fix-ui.js?v=20260817-21','./subscription-ui.js?v=20260817-21','./usage-quota-ui.js?v=20260817-21','./ux-stability-fix.js?v=20260817-21','./ui-polish-final.js?v=20260817-21','./ui-final-touch.js?v=20260817-21','./promptai-experience-v1.js?v=20260817-21','./promptai-loading-v2.js?v=20260817-21','./promptai-experience-v2.js?v=20260817-21','./promptai-home-final.js?v=20260817-21','./brand-werkstatt.js?v=20260817-21','./promptai-nav-drawer.js?v=20260817-21'];
  ...
  async function critical(){preloadCritical();let ready=0;for(const src of CRITICAL_SCRIPTS){await (src==='core'?loadCore():load(src));bootProgress(++ready/CRITICAL_SCRIPTS.length)}await load('./promptai-full-app-design.js?v=20260817-21');document.querySelector('#freePromptCategory option[value="website"]')?.remove();const intro=document.querySelector('#freePromptDialog .free-prompt-intro');if(intro)intro.textContent='Wähle jetzt Typ und Ziel-Tool. Weitere Angaben sind optional.';document.documentElement.classList.add('prompt-home-ready')}
  async function adminExtras(){await load('./admin-ai-ui.js?v=20260817-21');await load('./admin-prompts-ui.js?v=20260817-21');await load('./admin-tokens-ui.js?v=20260817-21');await load('./system-ai-studio.js?v=20260817-21')}
  async function previewExtras(){await load('./sandbox-preview.js?v=20260817-21');await load('./github-sandbox.js?v=20260817-21')}
  async function accountExtras(){await load('./learning-controls.js?v=20260817-21')}
  function lazy(){document.addEventListener('click',e=>{if(e.target.closest?.('#adminBtn'))adminExtras();if(e.target.closest?.('#workspacePreviewBtn'))previewExtras();if(e.target.closest?.('#accountBtn,#welcomeAccountBtn'))accountExtras()},{capture:true});const idle=window.requestIdleCallback||((fn)=>setTimeout(fn,900));idle(async()=>{await load('./project-history.js?v=20260817-21');await load('./generator-selection.js?v=20260817-21')},{timeout:2500})}
