(()=>{
  ...
  async function adminExtras(){await load('./admin-ai-ui.js?v=20260814-1');await load('./admin-prompts-ui.js?v=20260815-3');await load('./system-ai-studio.js?v=20260815-1')}
