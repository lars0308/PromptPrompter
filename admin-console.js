(()=>{
  ...
  const CORE_SCRIPT='./admin-console-core.js?v=20260815-3';
  ...
  const CRITICAL_SCRIPTS=['./cloud-fast-bundle.js?v=20260813-2','./mode-handoff-fix.js?v=20260815-2','./transition-polish.js?v=20260815-5','./announcement-popup.js?v=20260815-1','core','./ui-regression-fixes.js?v=20260814-1','./project-start-ui.js?v=20260815-1','./stability-ui.js?v=20260815-1','./mode-flow-ui.js?v=20260813-3','./system-ai-routing.js?v=20260813-2','./system-ai-studio.js?v=20260815-1','./product-polish.js?v=20260813-2','./workflow-cleanup.js?v=20260815-3','./preview-mode-fix.js?v=20260815-1','./free-prompt-ui.js?v=20260815-2','./free-prompt-presets.js?v=20260813-2','./home-entry-ui.js?v=20260815-4','./website-build-ui.js?v=20260815-3','./project-extras-ui.js?v=20260815-2','./welcome-intro-ui.js?v=20260815-1','./project-context-ui.js?v=20260815-1','./save-toast-ui.js?v=20260815-1','./settings-connections-ui.js?v=20260815-4','./user-preferences-ui.js?v=20260815-1','./streamlined-project-flow.js?v=20260815-2','./guided-clean-ui.js?v=20260815-2','./unified-ui-v1.js?v=20260815-1','./trial-fix-ui.js?v=20260815-1','./subscription-ui.js?v=20260813-2','./usage-quota-ui.js?v=20260815-1','./ux-stability-fix.js?v=20260813-4','./ui-polish-final.js?v=20260815-1','./ui-final-touch.js?v=20260813-2','./promptai-experience-v1.js?v=20260813-2','./promptai-loading-v2.js?v=20260813-2','./promptai-experience-v2.js?v=20260813-2','./promptai-home-final.js?v=20260813-2'];
  ...
  async function adminExtras(){await load('./admin-ai-ui.js?v=20260814-1');await load('./admin-prompts-ui.js?v=20260815-3');await load('./admin-tokens-ui.js?v=20260815-1');await load('./system-ai-studio.js?v=20260815-1')}
  ...
  function lazy(){document.addEventListener('click',e=>{if(e.target.closest?.('#adminBtn'))adminExtras();if(e.target.closest?.('#workspacePreviewBtn'))previewExtras();if(e.target.closest?.('#accountBtn,#welcomeAccountBtn'))accountExtras()},{capture:true});const idle=window.requestIdleCallback||((fn)=>setTimeout(fn,900));idle(async()=>{await load('./project-history.js?v=20260814-1');await load('./generator-selection.js?v=20260815-1')},{timeout:2500})}
