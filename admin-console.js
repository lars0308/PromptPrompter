(()=>{
  ...
  const CRITICAL_SCRIPTS=['./cloud-fast-bundle.js?v=20260813-2','./mode-handoff-fix.js?v=20260814-2','./transition-polish.js?v=20260814-4','./announcement-popup.js?v=20260814-1','core','./ui-regression-fixes.js?v=20260814-1','./project-start-ui.js?v=20260814-1','./stability-ui.js?v=20260813-4','./mode-flow-ui.js?v=20260813-3','./system-ai-routing.js?v=20260813-2','./system-ai-studio.js?v=20260813-2','./product-polish.js?v=20260813-2','./workflow-cleanup.js?v=20260814-3','./preview-mode-fix.js?v=20260814-1','./free-prompt-ui.js?v=20260813-2','./free-prompt-presets.js?v=20260813-2','./home-entry-ui.js?v=20260814-2','./streamlined-project-flow.js?v=20260813-2','./guided-clean-ui.js?v=20260814-2','./unified-ui-v1.js?v=20260814-2','./trial-fix-ui.js?v=20260814-1','./subscription-ui.js?v=20260813-2','./usage-quota-ui.js?v=20260813-2','./ux-stability-fix.js?v=20260813-4','./ui-polish-final.js?v=20260813-2','./ui-final-touch.js?v=20260813-2','./promptai-experience-v1.js?v=20260813-2','./promptai-loading-v2.js?v=20260813-2','./promptai-experience-v2.js?v=20260813-2','./promptai-home-final.js?v=20260813-2'];
  async function critical(){let ready=0;for(const src of CRITICAL_SCRIPTS){await (src==='core'?loadCore():load(src));bootProgress(++ready/CRITICAL_SCRIPTS.length)}document.querySelector('#freePromptCategory option[value="website"]')?.remove();const intro=document.querySelector('#freePromptDialog .free-prompt-intro');if(intro)intro.textContent='Wähle jetzt Typ und Ziel-Tool. Weitere Angaben sind optional.';document.documentElement.classList.add('prompt-home-ready')}
