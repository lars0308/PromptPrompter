const CACHE='prompt-ai-shell-v23';
const SHELL=['/','/index.html','/styles.css','/app.js','/cloud.js','/admin-console.js','/admin-console-core.js','/admin-ai-ui.js','/owner-access.js','/intro-flow-fix.js','/ui-regression-fixes.js','/project-start-ui.js','/stability-ui.js','/mode-flow-ui.js','/preview-ai-admin.js','/product-polish.js','/sandbox-preview.js','/workflow-cleanup.js','/generator-selection.js','/manifest.webmanifest','/sitebrief-logo.svg','/intro.mp4','/intro.webm'];
